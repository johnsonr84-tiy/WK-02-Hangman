...
function checkGuess () {
  if (gameStatus.randomWord.indexOf(gameStatus.guess) === -1) {
    ...
    gameStatus.mistakeMessage = 'You have ' + gameStatus.mistakes + ' mistakes left.'
...
function userGuess() {
  ...
  if (gameStatus.tracker.join('') === gameStatus.randomWord) {
    gameStatus.feedback = 'You have won this game, you lucky dog!\nThe word was: ' + gameStatus.randomWord;
  }
  else if (gameStatus.mistakes === 0) {
    gameStatus.feedback = 'Oh bother. You lost the game.\nThe word was: ' + gameStatus.randomWord;
